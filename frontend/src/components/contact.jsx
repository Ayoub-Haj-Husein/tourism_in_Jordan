            ...
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    ...
                    <p class="mb-16 text-base text-center text-gray-500">
                        Do you have something to tell us? Suggestion? Complains? Tell us here!
                    </p>
                </div>
            </div>
                ...
                <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                    <div
                        ...
                        <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                            Email</h2>
                        <a href="#"
                            class="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">Melad.k.abulail@gmail.com</a>
                    </div>
                </div>
                <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                    <div
                        ...
                        <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                            Phone</h2>
                        <a href="#"
                            class="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">+962776877452</a>
                    </div>
                </div>
                <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                    <div
            ...
            <div class="px-8 py-8 bg-white border rounded-md shadow-md dark:border-gray-800 dark:bg-gray-800">
                <form action="">
                    ...
                    <input
                        ...
                        type="email" placeholder="Email@gmail.com" required=""></input>
